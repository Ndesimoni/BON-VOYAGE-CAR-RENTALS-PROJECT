      ...
      <div className="flex justify-center flex-col items-center mb-24">
        <div>
          <div className="w-[1205px]">
            <div className="p-1">
              <p className="font-bold text-2xl mb-1 text-green-600">
                More Services
              </p>

              <p>
                Trust your local Enterprise experts to help you find the light
                and medium-duty vehicles you need,
              </p>
            </div>
            ...
            <motion.div
              ...
              whileInView="animate"
              viewport={{ once: false }}
              className="grid grid-cols-3  gap-x-20 mt-3 gap-y-24  "
            >
              <ExtraFeaturesBlog
                icon={<IoTimeOutline />}
              ...
              <ExtraFeaturesBlog
                ...
                text="When renting a car with BonVoyage, you get free access to 24/7 customer support for every iss"
              />
              <ExtraFeaturesBlog
                icon={<RiSecurePaymentLine />}
                heading="A Secure Payment Gateway"
                text="You do not need to feel insecure while making online payments. We provide you with a 100% secure payment gateway"
              />
              <ExtraFeaturesBlog
                icon={<IoCarSportOutline />}
                heading="Cars For Professional Needs"
                text="You can easily rent a fleet of vehicles if you need the for any professional or personal course"
              />
              <ExtraFeaturesBlog
                icon={<IoCarOutline />}
                heading="Special Cars On Demand"
                text="Don't worry about finding luxury cars for special days. We have a set of luxury cars for you"
              />
            </motion.div>
          </div>
        </div>
